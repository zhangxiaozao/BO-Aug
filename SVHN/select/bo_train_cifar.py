...
import SVHN.select.custom_ops as ops
from SVHN.select import data_utils_1000
from SVHN.select import helper_utils
import numpy as np
import tensorflow as tf
from SVHN.select.wrn import build_wrn_model
from SVHN.select import bo_policies
...
def main(policies, time):
  ...
  if MODEL_NAME == 'wrn':
    ...
    hparams.add_hparam('weight_decay_rate', 0.03)
  ...
  SVHN_trainer = SVHNModelTrainer(hparams, temp_checkpoint_dir)
  acc = SVHN_trainer.run_model()
